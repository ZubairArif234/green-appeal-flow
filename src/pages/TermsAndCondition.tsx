  ...
  return (
    <div>
      ...
      <div className="mb-20 mt-40 max-w-6xl mx-auto">
        <b className="text-2xl block mb-6">Terms of Service</b>
...
for your billing, appeals, and payer interactions.
        ...
        <div className="mb-4">
          ...
          <p className="mb-2">
Cove Health does not intentionally store or retain user-submitted input 
...
party AI providers via secure API connections.
          </p>
...
fully de-identified and free of PHI or other sensitive information.
          ...
          <p className="mb-2">
We may store and analyze the outputs generated by the Service (i.e., the AI-
...
internally without restriction, subject only to applicable law.
          </p>
          <p className="mb-2">
We recommend you review the privacy policies of any third-party platforms 
integrated into the Service for details on their data handling practices.
          </p>
...
or related to your use of the Service, including but not limited to:
          ...
          <ul className="list-disc mt-2 ms-10">
            ...
            <li>Data breaches resulting from user input errors</li>
          </ul>
        </div>
...
or expenses (including legal fees) arising out of:
          ...
          <ul className="list-disc mt-2 ms-10">
            ...
            <li>Any data you submit, including PHI or otherwise sensitive information.</li>
          </ul>
        </div>
