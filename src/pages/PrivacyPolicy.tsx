...
with the Service.
          ...
          <ul className="list-disc mt-2 ms-10">
            <li>
             Account Information (name, email, login credentials, etc.)</li>
            <li>
              Usage Information (e.g., IP address, browser type, device identifiers, 
activity logs, time spent).
            </li>
            <li>
             Submission Metadata (e.g., file types, timestamps, API activity).
             </li>
            <li>
            Output Data – generated results, insights, recommendations, or 
analysis returned by the Service.</li>
            <li>
            Aggregated or Derived Data created by us from any of the above.</li>
          </ul>
...
analyzed, or used by us without restriction, provided it does not contain PHI.
        ...
        <div className="mb-4">
          ...
          <p>We may use any information collected or derived through the Service—
including outputs—for any lawful purpose, including but not limited to:</p>
          <ul className="list-disc mt-2 ms-10">
...
aggregated formats).</li>
           ...
           <p>We reserve the right to analyze, retain, modify, reproduce, and use any 
output data and associated usage patterns, in perpetuity, for any purpose, 
subject only to applicable laws and the exclusion of PHI.</p>
